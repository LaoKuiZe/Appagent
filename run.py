...
print_with_color("Welcome to the deployment phase of AppAgentPro!\nYou can give me the task description and I will try my best to complete the task without your intervention.", "yellow")
